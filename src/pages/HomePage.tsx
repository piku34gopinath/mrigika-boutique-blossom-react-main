...
const HomePage: React.FC = () => {
	...
	return (
		<div className="min-h-screen">
			...
			<section className="py-10 sm:py-16 fade-in slide-up">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-8 sm:mb-12">
						<h2 className="text-3xl sm:text-4xl font-playfair font-bold mb-3 sm:mb-4 text-primary">
							Our Collections
						</h2>
					...
					<div className="fade-in slide-in-left animate-carousel">
						<Carousel
							opts={{ loop: true, align: "start" }} /* Changed align to start for better mobile view */
							className="mb-10 sm:mb-16 w-full"
						>
							<CarouselContent className="-ml-4"> {/* Adjusted margin */}
								{categories.map((category) => (
									<CarouselItem key={category.key} className="pl-4 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4"> {/* Responsive basis */}
										<div
											...
											style={{ animationDelay: "0.5s", height: "300px" }} /* Adjusted height */
										...
										>
											...
											/>
											<div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-end opacity-90 group-hover:opacity-100 transition-opacity p-4"> {/* Adjusted padding */}
												<h3 className="text-2xl sm:text-3xl font-playfair font-bold text-white mb-1 sm:mb-2 drop-shadow-lg"> {/* Responsive font size and margin */}
													{category.name}
												</h3>
												<p className="text-sm sm:text-lg text-white drop-shadow-md"> {/* Responsive font size */}
							...
							<CarouselPrevious className="left-2 sm:left-6" /> {/* Responsive position */}
							<CarouselNext className="right-2 sm:right-6" /> {/* Responsive position */}
						</Carousel>
					</div>
				</div>
			</section>
			...
			{/* Featured Products */}
			<section className="py-10 sm:py-16 bg-secondary/30 fade-in slide-up">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-8 sm:mb-12">
						<h2 className="text-3xl sm:text-4xl font-playfair font-bold mb-3 sm:mb-4 text-primary">
							Featured Collection
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12"> {/* Responsive columns and gap */}
					...
					<div className="text-center">
						<button onClick={() => navigate("/shop")} className="btn-boutique text-base sm:text-lg px-6 py-2.5 sm:px-8 sm:py-3"> {/* Responsive padding and font size */}
							View All Products
						</button>
					</div>
				</div>
				...
				{/* Features Section */}
				<section className="py-10 sm:py-16 bg-muted/30 fade-in slide-up">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8"> {/* Responsive columns and gap */}
						{features.map((feature, index) => (
							<div
								key={index}
								className={`text-center p-4 sm:p-6 rounded-2xl bg-card border border-border shadow-soft hover:shadow-elegant transition-all duration-300 fade-in slide-up animate-feature-card`}
								style={{ animationDelay: `${index * 0.15 + 0.2}s` }}
							>
								<div className="flex justify-center mb-3 sm:mb-4">{feature.icon}</div> {/* Responsive margin */}
								<h3 className="font-playfair font-semibold text-base sm:text-lg mb-1.5 sm:mb-2 text-primary"> {/* Responsive font size and margin */}
									{feature.title}
								</h3>
								<p className="text-muted-foreground text-xs sm:text-sm"> {/* Responsive font size */}
									{feature.description}
								</p>
							</div>
						))}
			...
			{/* About Section */}
			<section className="py-10 sm:py-16 bg-secondary fade-in slide-up">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-2xl lg:max-w-4xl mx-auto text-center">
						<h2 className="text-3xl sm:text-4xl font-playfair font-bold mb-4 sm:mb-6 text-primary"> {/* Responsive font size and margin */}
							About Mrigika
						</h2>
						<p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-6 sm:mb-8"> {/* Responsive font size and margin */}
						...
						<div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center"> {/* Responsive gap */}
							<a
								href="https://www.instagram.com/mrigika/?igsh=MTAwazc0MTA0N29jbQ=="
								target="_blank"
								rel="noopener noreferrer"
								className="btn-secondary text-sm sm:text-base px-6 py-2.5 sm:px-8 sm:py-3" /* Responsive padding and font size */
							>
								Our Story on Instagram
							</a>
							<button onClick={() => navigate("/contact")} className="btn-secondary text-sm sm:text-base px-6 py-2.5 sm:px-8 sm:py-3">Visit Our Store</button> {/* Responsive padding and font size */}
						</div>
					</div>
				</div>
			</section>
