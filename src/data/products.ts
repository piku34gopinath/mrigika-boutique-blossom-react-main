...
export const products: Product[] = [
  // Saree Section (6 products)
  {
    ...
    category: 'sarees',
    sizes: ['5.5 mtr saree with 0.8 mtr running blouse piece'],
    colors: ['sky Blue'],
    featured: true,
  },
  {
  ...
  {
    id: '4',
    name: 'Orgenza hand painted Saree',
    price: 24800,
    description: 'Lightweight and elegant orgenza saree for occasion.',
    image: [guduSaree,],
    category: 'sarees',
    sizes: ['5.5 mtr saree with 0.8 mtr running blouse piece'],
    colors: ['Rust orange'],
  },
  {
    ...
    price: 14500,
    description: 'Rich texture with golden hues, showcasing the beauty of Hand embriodery.',
  ...
  {
    id: '6',
    name: 'organza sambalpuri Saree',
    price: 11999,
    description: 'Orgenza  saree with intricate sambalpuri work, perfect for weddings and special occasions.',
  ...
  },
  {
    ...
    price: 15700,
    description: 'silk saree with intricate painting work, perfect for weddings and special occasions.',
  ...
  },
  {
    ...
    name: 'Hand painted silk Saree',
    price: 14700,
    description: 'silk saree with multi colour African tribal art, perfect for weddings and special occasions.',
 ...
 
  {
    ...
    name: 'Floral Lehenga',
    price: 7899,
    description: 'Floral lehenga with Hand embroidered top.',
  ...
  {
    id: '10',
    name: 'Sambalpuri net Lehenga',
    price: 7999,
    description: 'Traditional sambalpuri cloth with net combined lehenga.',
  ...
  {
    id: '11',
    name: 'Indo western Sambalpuri gown',
    price: 12500,
    description: 'Sambalpuri gown perfect for grand celebrations.',
  ...
  },
  {
    ...
    price: 15000,
    description: 'Hand embroidery with Sambalpuri cloth gown, perfect for festive celebrations and weddings.',
